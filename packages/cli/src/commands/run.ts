...
import { RequestRunner } from '@radius/core';
import { NodeHttpClient } from '@radius/core/node';
import { EnvironmentManager } from '@radius/core/environment';
import { SessionManager } from '@radius/core/session';
import type { RadiusResponse } from '@radius/core';
...
export async function runCommand(targetPath: string, options: RunOptions): Promise<void> {
    ...
    sessionManager = new SessionManager({ fs: fsAdapter });
