...
> **Detailed Reference:** For a complete breakdown of the strict V2 schema (including array-based headers/params and explicit body types), see [Schema V2 Reference](docs/schema_v2_reference.md).
...
> **Detailed Reference:** For a complete breakdown of the Environment Profile schema, see [Environment Schema Reference](docs/environment_schema_reference.md).
